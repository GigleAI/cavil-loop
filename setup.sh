...
for ld in "pending/agent|5539d3|等待 agent 处理" "pending/agent/fable5|8250df|等待 agent 使用 Claude Fable 5 模型处理" "doing/agent|0e8a16|agent 正在处理" "pending/human|4bc81f|等待人类处理" "pending/PR|bfd4f2|工作已转 PR 跟踪" "Done|586069|已结案"; do
