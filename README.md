...
安装位置：`~/.claude/skills/coding-agent-workflow/`。脚本、systemd 模板、prompt 模板全在这。
...
bash ~/.claude/skills/coding-agent-workflow/scripts/session-log.sh 42        # 打印路径
bash ~/.claude/skills/coding-agent-workflow/scripts/session-log.sh 42 -c     # cat
bash ~/.claude/skills/coding-agent-workflow/scripts/session-log.sh 42 -f     # tail -F 跟随
```
